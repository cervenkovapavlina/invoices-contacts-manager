...
class Contact(Entity):
    ...
    registration_number = models.CharField(max_length=30, unique=False, null=True, default="")
    vat_number = models.CharField(max_length=30, unique=False, null=True, default="")
